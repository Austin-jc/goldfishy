...
`index.html` here is the public landing page, served by GitHub Pages (Settings → Pages → Deploy from branch → `main` / `docs`). The `.nojekyll` file keeps Pages from running Jekyll over this folder.

| Doc | What's in it |
|---|---|
| [motivations.md](motivations.md) | Why the app exists, use cases, philosophy, the bar for new features |
| [architecture.md](architecture.md) | System/code architecture: stack, data model, background engine, concurrency, invariants |
